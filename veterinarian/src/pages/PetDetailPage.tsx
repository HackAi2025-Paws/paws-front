...
export default function PetDetailPage() {
  ...
  const { toggleListening, finalText, currentTranscript } = useSpeechToText();
          ...
          <div className="tabContent">
            <div className="clinicalSummary">
              <div className="summaryGrid">
                ...
                <div className="summarySection">
                  <h4 className="summarySection__title">
                  ...
                  <div className="summarySection__content">
                    <ul className="summaryList">
                      {mockClinicalSummary.riskFactors.map((risk, index) => (
                        <li
                          key={index}
                          className="summaryList__item summaryList__item--risk"
                        >
                          <span className="summaryList__icon">!</span>
                          {risk}
                        </li>
              ...
              <div className="summaryFooter">
                <div className="summaryNote">
                  🤖{" "}
                  <em>
                    Resumen generado automáticamente basado en el historial
